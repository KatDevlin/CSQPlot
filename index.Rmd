...
```{r function}
# A function to make chi-square quantile plots to test for multivariate normality
# of data or residuals. This function is not my own - written by Prof. Jonathan
# Reuning-Scherer for Yale's Multivariate Statistics 660 course.
